  ...
  return(
    <div className={'mx-32 border-[2px] border-black px-8 py-2'}>
      ...
      <div className={'flex justify-center mt-2'}>
        <button className={'px-4 py-2 border-black border-[2px] rounded-full hover:bg-blue-600 hover:text-white duration-300 transition-all'} onClick={handleSubmit(addHandler)}>Thêm sản phẩm</button>
      </div>
    </div>
  )
}